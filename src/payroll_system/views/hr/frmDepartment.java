...
public class frmDepartment extends Base {
	 ...
	 * Create the frame.
	 */
	public frmDepartment(String title, String state, DepartmentService ds) {
		...
		txtName.setToolTipText("Enter department name");
		...
		JLabel lblTitle = new JLabel("DEPARTMENT CATEGORY");
